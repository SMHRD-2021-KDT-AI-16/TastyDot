...
public final class FragmentUserInfoBinding implements ViewBinding {
  ...
  private FragmentUserInfoBinding(@NonNull FrameLayout rootView, @NonNull Guideline guideline3,
      ...
      @NonNull TextView textView27, @NonNull TextView textView29, @NonNull TextView textView31,
      @NonNull TextView tvChange, @NonNull TextView tvUserLogout, @NonNull TextView tvUserName,
  ...
  public static FragmentUserInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentUserInfoBinding((FrameLayout) rootView, guideline3, guideline5,
          imageView16, imageView17, imageView7, textView15, textView16, textView27, textView29,
          textView31, tvChange, tvUserLogout, tvUserName, tvUserUsedCoupon);
    }
